...
import { Info, ArrowLeft, Wrench } from 'lucide-react';
...
export default function TentangKami() {
  return (
    <div className="bg-[#F2EBE3] min-h-screen flex flex-col items-center justify-center p-6 relative">
      ...
      {/* Kartu Konten */}
      <div className="bg-[#E0D4C6] p-10 md:p-14 rounded-[40px] shadow-xl border border-[#D1C4B4] flex flex-col items-center text-center max-w-md w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="h-20 w-20 bg-orange-500 rounded-full flex items-center justify-center text-white mb-6 shadow-lg shadow-orange-500/30">
          <Info size={40} />
        </div>
        <h1 className="text-2xl md:text-3xl font-black text-gray-900 uppercase tracking-tighter mb-3">Tentang Kami</h1>
